...
parser.add_argument('--save_dir', default='.', help='path to save pickled files')
...
if __name__ == "__main__":
    ...
    pickle_examples(sorted(glob.glob(os.path.join(args.dir, "*.jpg"))), train_path, val_path, args.split_ratio)